...
from app import app
from words.documents import ClosestWordLog, ProximityLog
...
class APITestCase(unittest.TestCase):
    ...
    def test_closest_word(self):
        word = 'lista'
        url = '/words/closest_word?possibilities={possibilities}&word={word}'.format(
    ...
    def test_proximity(self):
        word_a = 'list'
        url = '/words/proximity?word_a={word_a}&word_b={word_b}'.format(
            word_a=word_a,
            word_b='lista'
        )
